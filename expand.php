<?php
    ...
    echo $row['comment'];
    echo "</td><td style='display:flex;'><a href='./edit.php?id=".$_GET["id"]."'><div class='editbutton'>Edit</div><a href='./remove.php".$_GET["id"]."'><div class='removebutton'>Remove</div></div></a></td></tr>";
?>
